...
namespace FGMIS
{
    public partial class Form7 : Form
    {
        ...
        public Form7(string title, int activityId)
        {
            InitializeComponent();
            this.title = title;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (fieldsValid())
            {
                string[] row = { dataGridView2.RowCount + "", textBox5.Text, comboBox7.Text, comboBox4.Text, numericUpDown1.Value.ToString(), numericUpDown3.Value.ToString(), textBox8.Text, textBox9.Text, textBox2.Text, StatusOfIGA(), textBox10.Text, textBox1.Text };
                dataGridView2.Rows.Add(row);
                textBox5.Text = string.Empty;
            }
        }

        private string StatusOfIGA()
        {
        ...
        private Boolean fieldsValid()
        {
            ...
            string typeoftraining = (textBox8.Text).Trim();
            string typeofiga = (textBox2.Text).Trim();

            if (name.CompareTo(string.Empty) == 0)
            {
                MessageBox.Show("Please enter a valid group / individual name!", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            ...
            else if (typeoftraining.CompareTo(string.Empty) == 0)
            {
                MessageBox.Show("Please enter a valid type of training!", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            else if (typeofiga.CompareTo(string.Empty) == 0)
            {
                MessageBox.Show("Please enter a valid type of IGA activity!", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            else
            {
        ...
        private void SaveData(int saveOrUpdate)
        {
            ...
            if (mainFieldsValid())
            {
                ...
                activity.Totalnumberofmembers = Convert.ToInt32(numericUpDown2.Value);
                ...
                if (dataGridView2.RowCount > 1)
                {
                    ...
                    {
                        Participant7 participant = new Participant7();
                        if (dataGridView2.Rows[i].Cells[1].Value != null)
                            participant.Groupname = dataGridView2.Rows[i].Cells[1].Value.ToString();
                        
                        if (dataGridView2.Rows[i].Cells[2].Value != null)
                            participant.Disabled = GetDisabledInt(dataGridView2.Rows[i].Cells[2].Value.ToString());
                        ...
                        if (dataGridView2.Rows[i].Cells[6].Value != null)
                            participant.Typeoftraining = dataGridView2.Rows[i].Cells[6].Value.ToString();

                        if (dataGridView2.Rows[i].Cells[7].Value != null)
                            participant.Capital = dataGridView2.Rows[i].Cells[7].Value.ToString();

                        if (dataGridView2.Rows[i].Cells[8].Value != null)
                            participant.Typeofiga = dataGridView2.Rows[i].Cells[8].Value.ToString();

                        if (dataGridView2.Rows[i].Cells[9].Value != null)
                            participant.Statusofiga = dataGridView2.Rows[i].Cells[9].Value.ToString();

                        if (dataGridView2.Rows[i].Cells[10].Value != null)
                            participant.Amountofsaving = dataGridView2.Rows[i].Cells[10].Value.ToString();

                        if (dataGridView2.Rows[i].Cells[11].Value != null)
                            participant.Remark = dataGridView2.Rows[i].Cells[11].Value.ToString();
        ...
        private void InsertRegionAndKebeleData()
        {
            ...
            genericHelper.Insert("Kebele", kebele2, Properties.Settings.Default.UID);
        }
        ...
        {
            originalValue = (sender as TextBox).Text;
        ...
        {
            (sender as TextBox).Text = originalValue;
        }
        ...
        {
            originalValue2 = (sender as TextBox).Text;
            if (originalValue2.Length == 0)
                (sender as TextBox).Text = "0";
            if ((sender as TextBox).Text.Length > 0)
            {
                if ((sender as TextBox).Text.IndexOf('.') == 0)
        ...
        {
            (sender as TextBox).Text = originalValue2;
        }
