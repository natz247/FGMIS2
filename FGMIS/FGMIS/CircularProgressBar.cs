...
using System.Windows.Forms;
    ...
    public class CircularProgressBar : Control
    {
        ...
        private Color _ProgressColorBackground = Color.FromArgb(238, 238, 238);
            ...
            using (Bitmap bitmap = new Bitmap(this.Width, this.Height))
            {
                using (Graphics graphics = Graphics.FromImage(bitmap))
                {
                    ...
                    using (LinearGradientBrush brush = new LinearGradientBrush(this.ClientRectangle, this._ProgressColor1, this._ProgressColor2, LinearGradientMode.ForwardDiagonal))
                    {
                        ...
                        {
                            LinearGradientBrush brush2 = new LinearGradientBrush(this.ClientRectangle, this._ProgressColorBackground, this._ProgressColorBackground, LinearGradientMode.ForwardDiagonal);
                            Pen pen2 = new Pen(brush2, 4f);
                            ...
                            graphics.DrawArc(pen2, 0x12, 0x12, (this.Width - 0x23) - 2, (this.Height - 0x23) - 2, -90, (int)Math.Round((double)((360.0 / ((double)this._Maximum)) * 100)));
