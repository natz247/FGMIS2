...
namespace FGMIS
{
    public partial class Form6 : Form
    {
        ...
        public Form6(string title, int activityId)
        {
            InitializeComponent();
            this.title = title;
        ...
        private void PopulateFields(int activityId)
        {
            ...
            Activity6 activity = (Activity6)activity0;
            ...
            for (int i = 0; i < participantsList.Count; i++)
            {
                ...
                Participant6 participant = (Participant6)participant0;

                string[] row = { dataGridView2.RowCount + "", participant.Name, participant.Kebele, participant.Age.ToString(), GetStringFromInt(participant.Disabled)};
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (fieldsValid())
            {
                string[] row = { dataGridView2.RowCount + "", textBox5.Text, comboBox6.Text, numericUpDown1.Value.ToString(), comboBox7.Text};
                dataGridView2.Rows.Add(row);
        ...
        private void SaveData(int saveOrUpdate)
        {
            ...
            if (mainFieldsValid())
            {
                ...
                if (dataGridView2.RowCount > 1)
                {
                    ...
                    {
                        Participant6 participant = new Participant6();
                        ...
                        if (dataGridView2.Rows[i].Cells[3].Value != null)
                            participant.Age = Convert.ToInt32(dataGridView2.Rows[i].Cells[3].Value.ToString());
                        
                        if (dataGridView2.Rows[i].Cells[4].Value != null)
                            participant.Disabled = GetDisabledInt(dataGridView2.Rows[i].Cells[4].Value.ToString());
